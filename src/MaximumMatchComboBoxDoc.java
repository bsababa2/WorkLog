...
public class MaximumMatchComboBoxDoc extends PlainDocument {
    JComboBox comboBox;
    ComboBoxModel model;
    ...
    public MaximumMatchComboBoxDoc(final JComboBox comboBox) {
    ...
    private Object lookupItem(String pattern) {
        ...
        if (selectedItem != null && selectedItem.toString().contains(pattern)) {
            ...
            for (int i=0, n=model.getSize(); i < n; i++) {
                ...
                if (currentItem.toString().contains(pattern)) {
                    return currentItem;
                }
            }
        }
    ...
    private int getMaximumMatchingOffset(String pattern, Object selectedItem) {
        ...
        for (int i=0, n=model.getSize(); i < n; i++) {
            ...
            if (itemAsString.contains(pattern)) {
